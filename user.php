...
<div class="section">
    <h1 class="title">User Details</h1>
        ...
        <br><h1 class="title">Change your password</h1>
        ...
        <br><div class="control"><input class="button is-danger" id="changepasswd" onclick="changePasswd()" type="submit" name="changepasswd" value="Change your password"></div>
</div>
